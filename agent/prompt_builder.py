...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Completion: Before claiming the requested work is complete, verify every named acceptance criterion against "
    "available evidence; a plausible subset is insufficient. State remaining uncertainty. An observed worker or "
    "task status such as 'done' or 'completed' does not by itself establish that verification. Completing your plan "
    "is not itself the answer; the requested output must appear in your response.\n"
    "</verification>\n\n"
